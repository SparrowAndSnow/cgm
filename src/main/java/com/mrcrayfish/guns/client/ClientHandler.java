...
public class ClientHandler {
    ...
    private static void registerModelOverrides() {
        /* Weapons */
        ModelOverrides.register(ModItems.RIFLE_ASSAULT.get(), new SimpleModel(SpecialModels.ASSAULT_RIFLE::getModel));
        ...
        ModelOverrides.register(ModItems.RIFLE_TACTICAL.get(), new SimpleModel(SpecialModels.HEAVY_RIFLE::getModel));
        ModelOverrides.register(ModItems.PISTOL.get(), new SimpleModel(SpecialModels.MACHINE_PISTOL::getModel));
        ...
        ModelOverrides.register(ModItems.RIFLE_SCOUT.get(), new SimpleModel(SpecialModels.RIFLE::getModel));
