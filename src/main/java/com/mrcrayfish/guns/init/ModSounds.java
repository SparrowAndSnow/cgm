...
public class ModSounds 
{
	...
	public static final RegistryObject<SoundEvent> ITEM_SHOTGUN_TACTICAL_RELOAD = register("item.shotgun_tactical.reload");
	...
	public static final RegistryObject<SoundEvent> ITEM_SHOTGUN_AUTO_RELOAD = register("item.shotgun_auto.reload");
	...
	public static final RegistryObject<SoundEvent> ITEM_RIFLE_BATTLE_SOVIET_SILENCED_FIRE = register("item.rifle_battle_soviet_silenced.fire");
	public static final RegistryObject<SoundEvent> ITEM_RIFLE_BATTLE_SOVIET_ENCHANTED_FIRE = register("item.rifle_battle_soviet_enchanted.fire");
